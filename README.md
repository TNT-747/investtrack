...
- Track positions (stocks, crypto, funds…)
- View market price updates
- Access aggregated dashboards
- Login using secure JWT authentication

This project was developed as a J2EE Mini Project following cloud-native architecture best practices.
